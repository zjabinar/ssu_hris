...
/*update username*/
Route::get('updateusername','EmployeeController@updateUsename');
Route::get('updateleaveledger','EmployeeController@updateLeaveLedger');
...
/*Leave Module*/
Route::get('leave/{status}','LeaveController@leave');
...
Route::get('leave-ledger/{id}','LeaveController@leaveLedger');
...
/*Payroll Module*/
/*Employee Dashboard*/
Route::get('payroll/employee-payslip','PayrollController@employeePayslip');
Route::get('payroll/download-payslip/{id}','PayrollController@downloadPayslip');
Route::get('payroll/employe-loan','PayrollController@employeeLoan');
Route::get('payroll/download-loan/{id}','PayrollController@employeeLoansDownload');

/*Admin Dashboard*/
Route::get('payroll/employee-payslips','PayrollController@employeePayslips');
Route::get('payroll/employe-loans','PayrollController@employeeLoans');
...
/*Employee PDS*/
Route::get('employee/edit-pds','EmployeeController@viewEmployeePDS');
Route::post('employee/post-pds-infodetails','EmployeeController@postPDSInfoDetail');
Route::post('employee/post-pds-address','EmployeeController@postPDSAddress');
Route::post('employee/post-pds-family','EmployeeController@postPDSFamily');
Route::post('employee/post-pds-accounts','EmployeeController@postPDSAccounts');
Route::get('employee/download-pds','EmployeeController@downloadEmployeePDS');

Route::post('employee/add-child','EmployeeController@addChild');
Route::get('employee/delete-child/{id}','EmployeeController@deleteChild');

Route::post('employee/add-eligibility','EmployeeController@addEligibility');
Route::get('employee/delete-eligibility/{id}','EmployeeController@deleteEligibility');

Route::post('employee/add-experience','EmployeeController@addExperience');
Route::get('employee/delete-experience/{id}','EmployeeController@deleteExperience');

Route::post('employee/add-training','EmployeeController@addTraining');
Route::get('employee/delete-training/{id}','EmployeeController@deleteTraining');

Route::post('employee/add-organization','EmployeeController@addOrganization');
Route::get('employee/delete-organization/{id}','EmployeeController@deleteOrganization');

Route::post('employee/add-skill','EmployeeController@addSkill');
Route::get('employee/delete-skill/{id}','EmployeeController@deleteSkill');

Route::post('employee/add-recognition','EmployeeController@addRecognition');
Route::get('employee/delete-recognition/{id}','EmployeeController@deleteRecognition');

Route::post('employee/add-reference','EmployeeController@addReference');
Route::get('employee/delete-reference/{id}','EmployeeController@deleteReference');
...
/*IPCR*/
Route::get('ipcr/periods','EmployeeController@showIpcrPeriod');
Route::post('ipcr/post-ipcr-period','EmployeeController@PostIpcrPeriod');
Route::post('ipcr/update-ipcr-period','EmployeeController@updateIpcrPeriod');
Route::get('ipcr/delete-ipcr-period/{id}','EmployeeController@deleteIpcrPeriod');

Route::get('ipcr/groups','EmployeeController@showIpcrGroup');
Route::post('ipcr/post-ipcr-group','EmployeeController@PostIpcrGroup');
Route::post('ipcr/update-ipcr-group','EmployeeController@updateIpcrGroup');
Route::get('ipcr/delete-ipcr-group/{id}','EmployeeController@deleteIpcrGroup');

Route::get('ipcr/employee','EmployeeController@showIpcrEmployee');

Route::get('ipcr/employee-mfo/{id}','EmployeeController@showIpcrMfo');
Route::post('ipcr/post-ipcr-mfo','EmployeeController@PostIpcrMfo');
Route::post('ipcr/update-ipcr-mfo','EmployeeController@updateIpcrMfo');
Route::get('ipcr/delete-ipcr-mfo/{id}','EmployeeController@deleteIpcMfo');

Route::post('ipcr/post-ipcr-mfo-indicator','EmployeeController@PostIpcrMfoIndicator');
Route::post('ipcr/update-ipcr-mfo-indicator','EmployeeController@updateIpcrMfoIndicator');
Route::get('ipcr/delete-ipcr-mfo-indicator/{id}','EmployeeController@deleteIpcrMfoIndicator');


Route::get('ipcr/supervisory','EmployeeController@showIpcrSupervisory');
Route::get('ipcr/supervisory-employee/{id}','EmployeeController@showIpcrSupervisoryEmployee');
Route::get('ipcr/supervisory-employee-detail/{id}','EmployeeController@showIpcrSupervisoryEmployeeDetail');


Route::get('ipcr/supervisor-mfo/{id}','EmployeeController@showIpcrMfo');

Route::get('ipcr/supervisor-mfo-approval/{id}','EmployeeController@showIpcrSupervisorApproval');

Route::get('ipcr/supervisor-mfo-rating/{id}','EmployeeController@showIpcrSupervisorRatig');
