<?php
	...
	//work sheet name
    $objPHPExcel->getActiveSheet()->setTitle('Autofilter Range of Cells');	
	/*Default Font Set*/
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('A2', 'Autofilter Range of Cells');
	...
	/*AutoFilter*/
	$objPHPExcel->getActiveSheet()->setAutoFilter('B4:F4');
	...
	while ($aRow = mysqli_fetch_array($result)) {
			...
			$objPHPExcel->getActiveSheet()->getStyle('E'.$j)->getNumberFormat()->setFormatCode('0,000.00');
	...
	$file = 'autofilter-range-of-cells-'.$exportTime. '.xlsx'; //Save file name
