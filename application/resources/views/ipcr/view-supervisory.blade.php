                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">IPCR Supervisor</h3>
                                ...
                                @foreach($ipcr_periods as $ip)
                                    <tr>
                                        ...
                                        <td style="padding: 10px;" align="left" width="35%" >
                                            ...
                                            <a class="btn btn-success btn-xs pull-left" href={{url('ipcr/supervisory-employee/'.$ip->id)}}>Open</a>
                                        ...
                                        <td style="padding: 10px;" align="left" width="35%" >
                                            ...
                                            <a class="btn btn-success btn-xs pull-left" href="#">Open</a>
