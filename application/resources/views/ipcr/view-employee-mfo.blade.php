                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">IPCR Form</h3>
                            <a class="btn btn-primary pull-right" href="#" data-toggle="modal" data-target=".modal-groups-add"><i class="fa fa-plus"></i>&nbsp;Add MFO</a>
                            @include('ipcr.modal-employee-mfo-add')
                                ...
                                <tbody>
                                        ...
                                        @if ($grp_cnt_1>0)
                                            ...
                                            @foreach($ipcr_mfos as $mfos)
                                                <?php 
                                                    $mfo_indicators = App\IpcrRatingsDetail::where('employee_id',\Auth::user()->id)->where('ipcr_rating_id',$mfos->id)->get(); 
                                                ...
                                                @if ($mfos->mfo_group_id==1)
                                                    <tr >
                                                        ...
                                                        <td rowspan="{{$count_indicator}}">
                                                            <a class="btn btn-info btn-xs pull-left" href="#" data-toggle="modal" data-target=".modal-employee-mfo-indicator-add{{$mfos->id}}"><i class="fa fa-eye"></i>&nbsp;Add Indicator</a>
                                                             @include('ipcr.modal-employee-mfo-indicator-add')
                                                             <a class="btn btn-warning btn-xs pull-left" href="#" data-toggle="modal" data-target=".modal-employee-mfo-detail{{$mfos->id}}"><i class="fa fa-eye"></i>&nbsp;Edit MFO</a>
                                                             @include('ipcr.modal-employee-mfo-detail')
                                                        </td>
                                        ...
                                        @if ($grp_cnt_2>0)
                                            <tr>
                                                <td colspan="15">{{DB::table('ipcr_mfo_groups')->where('id', 2)->value('name')}} - {{DB::table('ipcr_employees')->where('id', session('ipcr_emp_rec_id'))->value('mfo_group_2_weight')}}%</td>
                                            </tr>
                                            @foreach($ipcr_mfos as $mfos)
                                                <?php 
                                                    $mfo_indicators = App\IpcrRatingsDetail::where('employee_id',\Auth::user()->id)->where('ipcr_rating_id',$mfos->id)->get(); 
                                        ...
                                        @if ($grp_cnt_3>0)
                                            <tr>
                                                <td colspan="15">{{DB::table('ipcr_mfo_groups')->where('id', 3)->value('name')}} - {{DB::table('ipcr_employees')->where('id', session('ipcr_emp_rec_id'))->value('mfo_group_3_weight')}}%</td>
                                            </tr>
                                            @foreach($ipcr_mfos as $mfos)
                                                <?php 
                                                    $mfo_indicators = App\IpcrRatingsDetail::where('employee_id',\Auth::user()->id)->where('ipcr_rating_id',$mfos->id)->get(); 
                                        ...
                                        @if ($grp_cnt_4>0)
                                            <tr>
                                                <td colspan="15">{{DB::table('ipcr_mfo_groups')->where('id', 4)->value('name')}} - {{DB::table('ipcr_employees')->where('id', session('ipcr_emp_rec_id'))->value('mfo_group_4_weight')}}%</td>
                                            </tr>
                                            @foreach($ipcr_mfos as $mfos)
                                                <?php 
                                                    $mfo_indicators = App\IpcrRatingsDetail::where('employee_id',\Auth::user()->id)->where('ipcr_rating_id',$mfos->id)->get(); 
                                        ...
                                        @if ($grp_cnt_5>0)
                                            <tr>
                                                <td colspan="15">{{DB::table('ipcr_mfo_groups')->where('id', 5)->value('name')}} - {{DB::table('ipcr_employees')->where('id', session('ipcr_emp_rec_id'))->value('mfo_group_5_weight')}}%</td>
                                            </tr>
                                            @foreach($ipcr_mfos as $mfos)
                                                <?php 
                                                    $mfo_indicators = App\IpcrRatingsDetail::where('employee_id',\Auth::user()->id)->where('ipcr_rating_id',$mfos->id)->get(); 
                                        ...
                                        @if ($grp_cnt_6>0)
                                            <tr>
                                                <td colspan="15">{{DB::table('ipcr_mfo_groups')->where('id', 6)->value('name')}} - {{DB::table('ipcr_employees')->where('id', session('ipcr_emp_rec_id'))->value('mfo_group_6_weight')}}%</td>
                                            </tr>
                                            @foreach($ipcr_mfos as $mfos)
                                                <?php 
                                                    $mfo_indicators = App\IpcrRatingsDetail::where('employee_id',\Auth::user()->id)->where('ipcr_rating_id',$mfos->id)->get(); 
                                        ...
                                        @if ($grp_cnt_7>0)
                                            <tr>
                                                <td colspan="15">{{DB::table('ipcr_mfo_groups')->where('id', 7)->value('name')}} - {{DB::table('ipcr_employees')->where('id', session('ipcr_emp_rec_id'))->value('mfo_group_7_weight')}}%</td>
                                            </tr>
                                            @foreach($ipcr_mfos as $mfos)
                                                <?php 
                                                    $mfo_indicators = App\IpcrRatingsDetail::where('employee_id',\Auth::user()->id)->where('ipcr_rating_id',$mfos->id)->get(); 
                                        ...
                                        @if ($grp_cnt_8>0)
                                            <tr>
                                                <td colspan="15">{{DB::table('ipcr_mfo_groups')->where('id', 8)->value('name')}} - {{DB::table('ipcr_employees')->where('id', session('ipcr_emp_rec_id'))->value('mfo_group_8_weight')}}%</td>
                                            </tr>
                                            @foreach($ipcr_mfos as $mfos)
                                                <?php 
                                                    $mfo_indicators = App\IpcrRatingsDetail::where('employee_id',\Auth::user()->id)->where('ipcr_rating_id',$mfos->id)->get(); 
