                        ...
                        <div class="panel-body">
                            ...
                            <form class="" role="form">
                                ...
                                <div class="form-group m-none">
                                    ...
                                    <input type="text" readonly class="form-control" value="{{$task->status}}">
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="tab-content p-20">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="task_discussion">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tr>
                                                    <td data-label="Member"><p>{{$tc->employee_name->firstname}}
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                @foreach($task_files as $tf)
                                                    <tr>
                                                        ...
                                                        <td data-label="Member"><p>{{$tf->employee_name->firstname}}

                                                                {{--<span class="label label-success"> {{$tf->employee_name->role}}</span></p></td>--}}

                                                        <td data-label="actions">
                                                            <a href="{{url('employee/task/download-file/'.$tf->id)}}" class="btn btn-success btn-xs"><i class="fa fa-download"></i> </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
