                            ...
                            <form role="form" method="post" action="{{url('employees/post-employee-personal-info')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required name="middlename" value="{{$employee->middlename}}">
                                        </div>
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                                <label for="el3">Designation</label>
                                                <select class="selectpicker form-control" data-live-search="true" name="designation" id="designation">
                                                    <option>{{language_data('Select Department')}}</option>
                                                    @foreach($designation as $d)
                                                        <option value="{{$d->id}}" @if($employee->designation==$d->id) selected @endif>  {{$d->designation}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datePicker" required="" name="hired_date" value="{{get_date_format($employee->hired_date)}}">
                                        </div>
