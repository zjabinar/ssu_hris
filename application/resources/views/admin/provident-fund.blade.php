                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($pfund as $pf)
                                <tr>
                                    <td data-label="Employee Name"><a href="{{url('employees/view/'.$pf->emp_id)}}">{{$pf->employee_info->firstname}} {{$pf->employee_info->lastname}}</a> </td>
                        ...
                        <form class="form-some-up" role="form" method="post" action="{{url('provident-fund/post-new-provident-fund')}}">
                            <div class="modal-body">
                                ...
                                <div class="show-fixed-amount">
                                    ...
                                    <div class="form-group">
                                        <label for="firstname">{{language_data('Employee Share')}}</label>
                                        <span class="help">({{language_data('Amount')}})</span>
                                        <input type="text" class="form-control" name="emp_share_fixed">
                                    </div>

                                    <div class="form-group">
                                        <label for="firstname">{{language_data('Organization Share')}}</label>
                                        <span class="help">({{language_data('Amount')}})</span>
