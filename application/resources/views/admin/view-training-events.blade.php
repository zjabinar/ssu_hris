                        ...
                        <div class="panel-body">
                            <form class="" role="form" action="{{url('training/post-training-events-update')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" multiple data-live-search="true" name="employee[]">
                                        @foreach($employee as $e)
                                            <option value="{{$e->id}}" @if(in_array_r($e->id,$event_members)) selected @endif>{{$e->fullname}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="hours"  value="{{$training_event->hours}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="textarea-wysihtml5 form-control" name="description" style="height:80px">{{$training_event->description}}</textarea>
                                </div>
