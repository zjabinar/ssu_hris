            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="active"><a href="#leave" aria-controls="leave" role="tab" data-toggle="tab"><i
                                ...
                                <div class="col-md-7">
                                    <form class="" role="form" action="{{url('settings/post-general-setting')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="show-smtp">
                                            ...
                                            <div class="form-group">
                                                <label for="firstname">{{language_data('SMTP Port')}}</label>
