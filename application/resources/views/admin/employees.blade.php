                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 5%;">{{language_data('Username')}}</th>
                                    <th style="width: 5%;">{{language_data('Designation')}}</th>
                                ...
                                <tr>
                                    <td data-label="SL">{{$d->fullname}}</td>
                                    <td data-label="Name"><p>{{$d->firstname}} {{$d->email}}</p></td>
                                    <td data-label="Username"><p>{{$d->user_name}}</p></td>
                                    {{-- <td data-label="Designation"><p>{{$d->designation_name->designation}}</p></td> --}}
                                    <td data-label="Designation"><p>{{ DB::table('sys_designation')->where('id', $d->designation)->value('designation') }}</p></td>
                                    @if($d->status=='active')
