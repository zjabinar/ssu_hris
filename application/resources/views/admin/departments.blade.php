                        ...
                        <div class="panel-body">
                            <form class="" role="form" action="{{url('departments/add')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="dep_long">
                                </div>
                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 35%;">{{language_data('Name')}}</th>
                                    <th style="width: 25%;">{{language_data('Description')}}</th>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Department"><p>{{$d->department}}</p></td>
                                     <td data-label="Department"><p>{{$d->dep_long}}</p></td>
                                    <td>
