			...
			<div class="p-30 p-t-none p-b-none">
				...
				<div class="panel">
					<div class="panel-heading p-b-none">
						<h3>{{language_data('Salary Statement')}}<br><small>{{language_data('Salary Statement')}} {{language_data('For')}}: {{$payslip->employee_info->firstname}} {{$payslip->employee_info->lastname}}</small></h3>
					</div>
						...
						<table class="table table-no-border table-condensed">
							<tbody>
								<tr>
									...
									<td><strong class="help-split">{{language_data('Employee Name')}}:</strong>{{$payslip->employee_info->firstname}} {{$payslip->employee_info->lastname}}</td>
								...
								<tr>
									...
									<td><strong class="help-split">{{language_data('Joining Date')}}:</strong>{{get_date_format($payslip->employee_info->hired_date)}}</td>
