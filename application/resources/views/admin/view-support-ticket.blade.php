                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">{{language_data('Change Basic Info')}}</h3>
                            </div>
                            <form class="" role="form" action="{{url('support-ticket/basic-info-post')}}" method="post">

                                <div class="form-group m-none">
                                    <label for="e20">{{language_data('Change Department')}}</label>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                @foreach($ticket_file as $tf)
                                                    <tr>
                                                        ...
                                                        <td data-label="Member"><p>{{$tf->employee_name->firstname}} <span class="label label-success"> {{$tf->employee_name->role}}</span></p></td>
