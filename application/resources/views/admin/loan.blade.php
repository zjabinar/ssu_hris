                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <td data-label="Employee Name"><a href="{{url('employees/view/'.$l->emp_id)}}">{{$l->employee_info->firstname}} {{$l->employee_info->lastname}}</a> </td>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form-some-up" role="form" method="post" action="{{url('loan/post-new-loan')}}">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="firstname">{{language_data('Title')}}</label>
                                    <input type="text" class="form-control" name="title" required="">
                                </div>

                                <div class="form-group">
                                    <label for="firstname">{{language_data('Loan')}} {{language_data('Date')}}</label>
                                    <input type="text" class="form-control datePicker" name="loan_date" required="">
                                </div>

                                <div class="form-group">
                                    <label for="firstname">{{language_data('Loan')}} {{language_data('Amount')}}</label>
                                ...
                                <div class="form-group">
                                    <label for="firstname">{{language_data('Monthly Repayment Amount')}}</label>
                                    <input type="number" class="form-control" name="repayment_amount" required="">
                                </div>


                                <div class="form-group">
                                    <label for="firstname">{{language_data('Repayment Start Date')}}</label>
